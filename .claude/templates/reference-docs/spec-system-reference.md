...
| --------------------- | ------------ | ---------- | ------------------------------------------------------------------------------------------------------- |
| `specRoots.business`  | `hand`       | `strict`   | humans + `/spec` — M1 (no tech leakage in prose) applies                                                |
