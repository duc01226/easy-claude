...
When this `.claude` folder is copied to a new project, relocate a root by declaring it in `docs/project-config.json` — never by editing the literals in prose or code.
