...
- Create ALL 8 tasks via `TaskCreate` before touching any file; run the fixed phase order `0 → 1 → 2 → 2.5 → 3 → 4 → 5 → final review` — fast-exit is a decision, never a silent omission.
