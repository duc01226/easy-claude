...
Keep intermediate assessments in `tmp/reports/`; durable journal entries belong in `./docs/journals/` — why: assessments support the work, journals preserve the event and its lessons.
...
**IMPORTANT MUST ATTENTION** Use the dated-slug **Journal output** contract above; keep intermediate assessments in `tmp/reports/` and durable journal entries in `./docs/journals/`.
