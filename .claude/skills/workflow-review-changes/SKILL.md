...
| "Same blocker again, one more loop will fix it"  | Cap at 2 no-progress repeats AND 2 rounds MAX → escalate via `AskUserQuestion` at whichever trips first; if issues increase round-over-round, STOP now.     |
