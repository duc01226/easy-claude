...
name: plan-analysis
version: 1.0.1
description: '[Planning] Use when the user supplies a plan file and asks to analyze it, assess impact, or verify planned changes.'
---
...
Build a structured knowledge model in `tmp/analysis/[plan-name].analysis.md`.
