...
description: '[Utilities] Use when a workflow step or the user asks for a diagram. Visualizes workflows, architectures or concepts as Excalidraw diagram JSON.'
---
