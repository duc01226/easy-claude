...
2b. **Plan the Demo Flows** — enumerate main-story/MVP flows, author one flow-spec per flow, `TaskCreate` one todo per flow ([BLOCKING], before generating)
