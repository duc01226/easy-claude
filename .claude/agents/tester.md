...
name: tester
description: >-
    Use when validating code through testing after a feature or significant
    change — runs unit and integration tests, analyzes results, checks
    coverage, verifies builds.
model: inherit
skills: test
memory: project
---
