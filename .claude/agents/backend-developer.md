...
> **MANDATORY MUST ATTENTION** Before implementing backend code, read these project-specific reference docs directly — the filenames below are canonical and resolve inside the reference-docs root (default `docs/project-reference`; a `docsRoots.projectReference.path` entry in `docs/project-config.json` overrides the path):
>
> - `backend-patterns-reference.md` — **primary source of truth**: CQRS commands/queries, validation, DTO mapping, repositories, event handlers, command/query structure, file layout
> - `domain-entities-reference.md` — entity catalog, relationships, cross-service sync
> - `project-structure-reference.md` — module/service list, directory tree, ports, build commands
> - `code-review-rules.md` — project-specific review checklist + anti-patterns
>
