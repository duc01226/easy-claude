...
**IMPORTANT MUST ATTENTION** read `frontend-patterns-reference.md` BEFORE writing code, and grep 3+ existing examples — never default to generic framework docs
...
**IMPORTANT MUST ATTENTION** NEVER put display logic or constants in components — place them in the data/model layer
**IMPORTANT MUST ATTENTION** add a final review task — verify lifecycle teardown, styling methodology, and a clean compile / type-check before reporting done
