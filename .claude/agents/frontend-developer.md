...
description: >-
    Use when creating or modifying frontend/UI components, forms, state,
    requests, or styling — follow the project's detected platform and documented
    conventions, using shared abstractions when they exist and fit.
model: inherit
memory: project
---
