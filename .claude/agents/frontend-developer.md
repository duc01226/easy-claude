...
**IMPORTANT MUST ATTENTION Goal:** Implement frontend components, stores, forms, services, templates matching the project's documented UI-stack conventions exactly — keeping the codebase consistent and free of stack drift.
