...
description: >-
    Use when investigating slow queries, N+1 patterns, memory leaks, API
    latency, bundle size, lazy loading, or render performance — adapts to the
    project's detected stack.
model: inherit
memory: project
---
