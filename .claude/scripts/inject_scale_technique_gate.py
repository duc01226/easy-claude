"""Inject SYNC:scale-technique-gate marker + reminder into the hand-picked host skills.
...
TAG = "SYNC:scale-technique-gate"
REMINDER_TAG = "SYNC:scale-technique-gate:reminder"
TOP_OPEN = f"<!-- {TAG} -->"
