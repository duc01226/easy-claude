...
const CHECKS = [
  ...
  {
    code: "SDD006",
    file: ".claude/skills/spec-tests/SKILL.md",
  ...
  {
    code: "SDD007",
    file: ".claude/skills/feature-spec/SKILL.md",
    requireAll: ["Section 8 owned exclusively by", "/spec-tests"],
    forbidAny: ["feature-spec owns Section 8"],
    message: "feature-spec update mode must delegate existing TC edits to spec-tests.",
  },
  {
    code: "SDD008",
    file: ".claude/skills/workflow-feature/SKILL.md",
    requireAll: ["performance-review", "SLA", "functional no-regression"],
    forbidPattern: /skip\s+`?\/?spec-tests`?/i,
  ...
  {
    code: "SDD016",
    file: ".agents/skills/spec-tests/SKILL.md",
    requireAll: ["emergency recovery", "recovery report", "target-source-path"],
    requireAny: ["AskUserQuestion", "direct user question"],
    forbidAny: PROJECT_LAYOUT_TERMS,
    message: "Codex spec-tests mirror must remain project-portable and require explicit reverse-sync recovery.",
  },
  {
    code: "SDD017",
    file: ".claude/skills/spec-tests/references/spec-tests-template.md",
  ...
  {
    code: "SDD017",
    file: ".agents/skills/spec-tests/references/spec-tests-template.md",
    requireAll: ["configured-source-path", "configured-test-path"],
    forbidAny: PROJECT_LAYOUT_TERMS,
