 ...
 *   - CLAUDE.md  — Claude Code root instructions. Generated by /ai-context-refresh
...
// CANONICAL contract: the generator (ai-context-refresh/scripts/generate-claude-md.cjs)
 ...
 * uses `--skip=claude-md` after source authoring so the root is not processed twice.
 */
const AGENT_FILES = [
    {
        file: 'CLAUDE.md',
        route: '/ai-context-refresh',
        aiRunnable: true,
