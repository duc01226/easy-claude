...
const SCRIPT_LINES = [
    ...
    "Here's what makes this powerful: swap project-config.json to point at any codebase and all 184 skills, 21 workflows, and 29 agents instantly adapt — zero reconfiguration of the intelligence layers above."
];
...
const LAYERS = [
    ...
    { label: 'Orchestration Layer', sub: '21 Workflows · JSON sequences · Step enforcement', color: C.green, icon: '🔄' },
    { label: 'Intelligence Layer', sub: '184 Skills · Shared protocols · Evidence gates', color: C.purple, icon: '⚡' },
    { label: 'Enforcement Layer', sub: '66 Hook Files · Safety · Quality · Context injection', color: C.blue, icon: '🪝' },
    { label: 'User Layer', sub: 'Developer prompt → Workflow router → auto-select /workflow-start', color: C.amber, icon: '👤' }
];
