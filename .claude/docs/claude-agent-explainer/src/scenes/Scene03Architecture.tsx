...
const SCRIPT_LINES = [
    ...
    "Here's what makes this powerful: swap project-config.json to point at any codebase and all 176 skills, 21 workflows, and 28 agents instantly adapt — zero reconfiguration of the intelligence layers above."
];
...
const LAYERS = [
    ...
    { label: 'Intelligence Layer', sub: '176 Skills · Shared protocols · Evidence gates', color: C.purple, icon: '⚡' },
