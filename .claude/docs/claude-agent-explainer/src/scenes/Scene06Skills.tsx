...
const SCRIPT_LINES = [
    'A skill is a Markdown file with YAML frontmatter that declares its name, version, and allowed tools — restricting what Claude can do while that skill runs. 184 skills cover every development stage, from planning and research to architecture review and release documentation.',
...
const CATEGORIES = [
    ...
    { label: 'Testing & TDD', skills: 'spec-tests · integration-test · e2e-test · test', color: C.amber },
