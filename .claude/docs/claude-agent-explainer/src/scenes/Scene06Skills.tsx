...
const SCRIPT_LINES = [
    'A skill is a Markdown file with YAML frontmatter that declares its name, version, and allowed tools — restricting what Claude can do while that skill runs. 176 skills cover every development stage, from planning and research to architecture review and release documentation.',
