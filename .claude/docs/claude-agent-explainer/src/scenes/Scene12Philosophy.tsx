...
const SCRIPT_LINES = [
    ...
    "The closing principle is the most important: build systems, not prompts. A clever prompt solves one problem once. A system solves all similar problems forever. The 66 top-level hook files, 176 skills, 21 workflows, and 28 agents you've seen here are a system — battle-tested across 12+ microservices and fully project-agnostic."
];
...
const TAGS = [
    ...
    { label: '176 Skills', color: C.purple },
