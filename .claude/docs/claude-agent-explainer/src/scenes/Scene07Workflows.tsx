...
const GROUPS = [
    ...
    { label: 'PBI & Discovery', count: 4, color: C.amber, examples: 'workflow-idea-to-pbi · workflow-idea-to-spec · workflow-research · workflow-spec-to-pbi' },
    { label: 'Spec-Driven', count: 2, color: C.purple, examples: 'workflow-code-to-spec · workflow-spec-sync' },
