...
const PHASES = [
    ...
    { num: '3', label: 'Test Specs', skills: 'spec-tests (3 modes) · review-artifact --type=spec-tests · idea-to-pbi', color: C.purple, icon: '🧪' },
    ...
    { num: '8', label: 'Documentation', skills: 'docs-update · feature-spec · changelog · release-notes', color: C.amber, icon: '📝' },
