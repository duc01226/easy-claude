...
This framework wraps Claude Code in a three-pillar execution framework — **16 top-level hook files**, **164 skills**, **19 registered workflows**, and **29 specialized agents** — that transforms a generic LLM into a project-aware, quality-enforced, hallucination-resistant development agent. The framework covers the **entire software development lifecycle** — from idea capture and TDD test specification through implementation, testing, E2E testing, code review, and documentation — with AI as a first-class participant at every stage.
...
graph TB
    ...
    subgraph "Intelligence Layer — 164 Skills"
...
### 5.2 Skill Categories (164 skills)
...
| **Prompt engineering quality**                 | 164 skills with YAML frontmatter + behavior protocols                                                    | Skills        |
...
| **Workflow trigger shortcuts**                 | 19 workflow-\* skills for workflow activation and lifecycle control                                      | Skills        |
...
**16 top-level hook files**, **164 skills**, **19 registered workflows**, and **29 specialized agents** working in concert to deliver:
...
- **Prompt engineering depth** — Role prompting, chain-of-thought, few-shot, negative prompting, and iterative refinement applied systematically across 164 skills (Section 8.15)
