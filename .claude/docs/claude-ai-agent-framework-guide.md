...
> **Document Sync Status** — Current local verification (2026-06-19): **15 hook files · 153 skills · 17 workflows · 29 agents** using the ADR-0002 filesystem metrics. Codex mirrors are committed under `.agents/`, `.codex/`, and `AGENTS.md`. Notable mechanisms documented here include multi-AI-tool portability (§13), behavioral-principle injection (§8.21), self-validating review (§8.20), and embedded sequential-thinking.
...
graph TB
    ...
    subgraph "Intelligence Layer — 153 Skills"
...
### 5.2 Skill Categories (153 skills)
...
| **Prompt engineering quality**                 | 153 skills with YAML frontmatter + behavior protocols                                                    | Skills        |
...
**15 top-level hook files**, **153 skills**, **17 registered workflows**, and **29 specialized agents** working in concert to deliver:
...
- **Prompt engineering depth** — Role prompting, chain-of-thought, few-shot, negative prompting, and iterative refinement applied systematically across 153 skills (Section 8.15)
