...
| **Skills** (Intelligence)     | Prompt-engineered protocols loaded on demand via `/skill-name`        | 158 skills              |
| **Workflows** (Orchestration) | Multi-step sequences of skills with progress tracking                 | 18 workflows            |
