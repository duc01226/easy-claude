...
> 161 skills across 15+ domains + 5 shared reference/protocol files for context-aware AI assistance
...
> Curated highlights — the full catalog has 161 skills; the tables below list selected skills per domain, not the complete set.
...
_Source: `.claude/skills/` | 161 skills across 15+ domains + 5 shared reference/protocol files_
