...
Create one task tracking todo per R-stage plus one per **release highlight** identified in R1.4, so each highlight is investigated (R2), written to the temp report (R5), rendered (R6), and verified (R8) individually.
