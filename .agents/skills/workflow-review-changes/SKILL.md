...
| "Same blocker again, one more loop will fix it"  | Cap at 3 no-progress repeats AND 5 rounds MAX → escalate by asking the user directly at whichever trips first; if issues increase round-over-round, STOP now.     |
