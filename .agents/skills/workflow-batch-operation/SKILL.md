...
**IMPORTANT MANDATORY Steps:** $plan -> $plan-review -> $plan-validate -> $why-review -> $code -> $tdd-spec -> $why-review -> $tdd-spec-review -> $tdd-spec [direction=sync] -> $integration-test -> $integration-test-review -> $integration-test-verify -> $workflow-review-changes -> $sre-review -> $test -> $docs-update -> $watzup -> $understand -> $workflow-end
...
**Steps:** $plan → $plan-review → $plan-validate → $why-review → $code → $tdd-spec → $why-review → $tdd-spec-review → $tdd-spec [direction=sync] → $integration-test → $integration-test-review → $integration-test-verify → $workflow-review-changes → $sre-review → $test → $docs-update → $watzup → $understand → $workflow-end
