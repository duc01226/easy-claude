...
| `$plan`                              | 2nd (pos 32) | PLAN₂: Sprint-ready implementation plan (after review-artifact --type=spec-tests)         |
| `$plan`                              | 3rd (pos 43) | PLAN₃: Integration test architecture plan (post-implementation)                           |
...
| `$plan-review`                       | 4th (pos 44) | Review PLAN₃ integration tests                                                            |
...
| `$spec [mode=tests]`                 | 2nd (pos 40) | TDD-SPEC₂: Post-implementation test spec update                                           |
| `$review-artifact --type=spec-tests` | 1st (pos 30) | Review TDD-SPEC₁                                                                          |
| `$review-artifact --type=spec-tests` | 2nd (pos 42) | Review TDD-SPEC₂                                                                          |
| `$test`                              | 1st (pos 48) | Test after integration tests                                                              |
| `$test`                              | 2nd (pos 52) | Final test verification                                                                   |
| `$review-domain-entities`            | 1st (pos 39) | DDD quality review — conditional: skip if no domain entity files in changeset             |
