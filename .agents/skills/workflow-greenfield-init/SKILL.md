...
| `$artifact-review --type=spec-tests` | 2nd (pos 42) | Review TDD-SPEC₂                                                                          |
| `$test`                              | 1st (pos 48) | Test after integration tests                                                              |
| `$test`                              | 2nd (pos 52) | Final test verification                                                                   |
| `$domain-entities-review`            | 1st (pos 39) | DDD quality review — conditional: skip if no domain entity files in changeset             |
