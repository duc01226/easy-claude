...
5. **Stop:** A clean review pass ENDS the review. If the same blocker repeats across 2 full invocations with no progress, escalate by asking the user directly.
