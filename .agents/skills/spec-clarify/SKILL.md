...
- **Fresh Context Review:** Validate findings, fix, restart the full review until clean; spawn a fresh zero-memory sub-agent after each fix cycle (re-review only — this skill itself runs inline).
