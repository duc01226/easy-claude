---
description: "Use when querying data, diagnosing database performance, optimizing schemas or indexes, managing backups, replication, monitoring, permissions, or running a database health assessment."
mode: subagent
---

<!-- GENERATED MIRROR of .claude/agents/database-admin.md — do not hand-edit; edit the canonical
     source and re-run: node .claude/skills/sync-opencode/scripts/run-opencode-sync.mjs -->

Source: .claude/agents/database-admin.md
...
- **Task Tracking & External Report:** ALWAYS one task at a time; persist to `tmp/reports/`.
