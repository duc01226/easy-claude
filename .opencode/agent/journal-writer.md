---
description: "Use when a significant technical difficulty occurs — repeated test failures, production bugs, flawed approaches needing redesign, blocking dependencies, security findings, failed migrations, broken pipelines."
mode: subagent
---

<!-- GENERATED MIRROR of .claude/agents/journal-writer.md — do not hand-edit; edit the canonical
     source and re-run: node .claude/skills/sync-opencode/scripts/run-opencode-sync.mjs -->

Source: .claude/agents/journal-writer.md
