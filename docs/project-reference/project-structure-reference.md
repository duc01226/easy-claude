...
| Skills         | <!-- COUNT:skills -->169<!-- /COUNT -->                                                       | `.claude/skills/*/SKILL.md`   | Markdown + YAML frontmatter                                                         |
...
| Codex Mirrors  | <!-- COUNT:skills -->169<!-- /COUNT --> skills, <!-- COUNT:agents -->27<!-- /COUNT --> agents | `.agents/`, `.codex/`         | Generated Codex-compatible copy                                                     |
...
| SK   | Skills         | `.claude/skills/`              | <!-- COUNT:skills -->169<!-- /COUNT --> task automation skill definitions                                                 |
