...
| Skills         | <!-- COUNT:skills -->159<!-- /COUNT -->                                                       | `.claude/skills/*/SKILL.md`   | Markdown + YAML frontmatter                                                                |
...
| Codex Mirrors  | <!-- COUNT:skills -->159<!-- /COUNT --> skills, <!-- COUNT:agents -->29<!-- /COUNT --> agents | `.agents/`, `.codex/`         | Generated Codex-compatible copy                                                            |
...
| SK   | Skills         | `.claude/skills/`              | <!-- COUNT:skills -->159<!-- /COUNT --> task automation skill definitions                                                   |
