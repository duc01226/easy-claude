...
- **IMPORTANT MUST ATTENTION** add final review task to verify all 8 sections present, sections 1-7 tech-free, all TCs have Business Intent / Invariant Guarded and Evidence fields, doc length in range
